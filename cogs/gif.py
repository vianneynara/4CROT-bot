...
class Events(commands.Cog):
    ...
    async def on_message(self, message):
        if message.author.bot:
            ...
            if 'forgor' in message.content.lower():
                ...
                await message.reply('https://cdn.discordapp.com/attachments/880509666482860042/884722248303403008/video0-18.mp4', mention_author=False)

            elif 'ok and?' in message.content.lower():
                await message.reply('https://tenor.com/view/file-size-was-too-big-to-upload-on-gamebanana-gif-22787008')
    ...
    async def pagi(self, ctx):
        await ctx.reply('https://media.discordapp.net/attachments/880509666482860042/886026262169145384/caption.gif', mention_author = False)

    @commands.command(name="siang")
    async def siang(self, ctx):
        await ctx.reply('https://media.discordapp.net/attachments/873613113855991828/878972885660733492/caption.gif', mention_author = False)

    @commands.command(name="sore")
    async def sore(self, ctx):
        await ctx.reply('https://media.discordapp.net/attachments/799121511470202921/905371859988668426/caption.gif', mention_author = False)

    @commands.command(name="malam")
    async def malam(self, ctx):
        await ctx.reply('https://media.discordapp.net/attachments/873613113855991828/878972799417466940/caption.gif', mention_author = False)
